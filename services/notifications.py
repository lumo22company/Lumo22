...
<p style="margin:0 0 12px;">Use the link below to open the <strong>upgrade</strong> page in your account (sign in when asked). Your one-off pack is pre-selected there with platforms, Story Ideas, and currency carried through—you can adjust anything, then continue to your order summary and checkout. You can update your form from that page or anytime under <strong>Edit form</strong> after you subscribe.</p>
...
Use the link below to open the upgrade page in your account (sign in when asked). Your one-off pack is pre-selected with platforms, Story Ideas, and currency carried through—you can adjust anything, then continue to checkout. You can update your form from there or anytime under Edit form after you subscribe.
