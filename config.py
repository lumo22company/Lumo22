...
class Config:
    ...
    # Set INTERNAL_ALERT_EMAIL in Railway if you want a different ops inbox; default below is hello@lumo22.com.
    ...
    # Optional OAuth: set in Railway to show "Continue with Google" on login & signup.
